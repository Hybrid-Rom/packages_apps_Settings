...
public class NxLongpressPreference extends DialogPreference implements
    ...
    public NxLongpressPreference(Context context, AttributeSet attrs) {
        ...
        mActionUri = uriRes != -1 ? context.getResources().getString(uriRes) : Settings.System.NX_LONGPRESS_TIMEOUT;

        mStoredVal = Settings.System.getIntForUser(mResolver, mActionUri, MAX_VAL, UserHandle.USER_CURRENT);
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        Settings.System.putIntForUser(mResolver, mActionUri, mStoredVal, UserHandle.USER_CURRENT);
    }
